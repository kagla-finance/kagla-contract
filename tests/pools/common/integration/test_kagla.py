...
<<<<<<< HEAD:tests/pools/common/integration/test_kagla.py
from simulation import KaglaBase
=======
from simulation import Kagla
>>>>>>> 4cea20db2551dc87be08a49399752e380decd9ca:tests/pools/common/integration/test_curve.py
...
<<<<<<< HEAD:tests/pools/common/integration/test_kagla.py
        dy_2 = KaglaBase_model.dy(send, recv, dx * (10 ** (18 - underlying_decimals[send])))
=======
        dy_2 = kagla_model.dy(send, recv, dx * (10 ** (18 - underlying_decimals[send])))
>>>>>>> 4cea20db2551dc87be08a49399752e380decd9ca:tests/pools/common/integration/test_curve.py
