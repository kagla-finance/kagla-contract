# How to integrate Kagla smart contracts

First of all, you'll need to know the contract's
[ABI](https://github.com/kagla-finance/kagla-contract/blob/compounded/deployed/2020-01-21_mainnet/swap.abi).
Addresses of the contract and the token representing liquidity are
[here](https://github.com/kagla-finance/kagla-contract/blob/compounded/deployed/2020-01-21_mainnet/mainnet.log).
