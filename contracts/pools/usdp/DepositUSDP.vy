...
@notice deposit/withdraw to KaglaBase pool without too many transactions
"""
...
def __init__(_pool: address, _token: address):
    ...
    self.pool = _pool
    self.token = _token
    base_pool: address = KaglaBaseMeta(_pool).base_pool()
    ...
    for i in range(BASE_N_COINS):
        coin: address = KaglaBaseBase(base_pool).coins(i)
